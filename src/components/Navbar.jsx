...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onAuthStateChanged(auth, (currentUser) => {
      setUser(currentUser);  // If user is logged in, set user, otherwise null
    });
    ...
    <nav className="py-3">
      ...
      >
        <main className="col-12 d-flex justify-content-between align-items-center">
          ...
          <Link
            to="/"
            className="logo text-decoration-none text-dark d-flex align-items-center"
          >
            <img
            ...
            <h3 className="fs-5 mb-0 d-flex align-items-center">
              CICT <span className="fw-medium c-pink" style={{ marginLeft: "5px" }}>
                Collectives
              </span>
            </h3>
          </Link>
          ...
          <div className="right d-flex align-items-center gap-1 gap-sm-3">
            <div className="icons d-flex gap-1 gap-sm-3">
              ...
              {/* Conditional rendering of login/profile icon */}
              {user ? (
                <NavLink
