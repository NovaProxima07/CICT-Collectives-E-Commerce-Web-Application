...
import slide_5_img from "../assets/slide-5.jpg";
...
const MixedAutoSlider = () => {
	...
	return (
		<section className="mixed-slider">
			...
			<div className="border-05 p-0 overflow-hidden d-flex">
				{/* Text section for the current slide */}
				<article className="text py-5 m-auto col-12 col-md-6 d-flex flex-column justify-content-center">
				...
				<div className="col-12 col-md-6">
					{sliderImages.map((img, index) => (
						<img
							key={index}
							className={`w-100 d-block mh-450 d-block ${
								activeSlide === index ? "animateSlide" : "d-none"
							}`}
							src={img}
							alt="One of the latest arrivals products"
							style={{
								objectFit: "cover", // Ensures the images maintain their aspect ratio and fill the container
								width: "100%", // Ensures the image spans the full width of its container
								height: "auto", // Adjusts the height automatically based on aspect ratio
							}}
						/>
					))}
				</div>
